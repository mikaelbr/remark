...
function fetch {
  curl -H "Accept: */*" -H "Accept-Encoding: gzip, deflate, sdch" -H "Accept-Language: nb,en-GB;q=0.8,en;q=0.6,en-US;q=0.4,sv;q=0.2,da;q=0.2" -H "Cache-Control: no-cache" -H "Connection: keep-alive" -H "Host: $2" -H "Origin: http://localhost:8080" -H "Pragma: no-cache" -H "Referer: http://localhost:8080/node_modules/remark-bekk/build/bekk.css" -A "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.130 Safari/537.36" $1 -o "lib/fonts/$3"
}
